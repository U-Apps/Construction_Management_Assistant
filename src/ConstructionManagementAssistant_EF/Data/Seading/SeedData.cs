...
public static class SeedData
{
    ...
    {
        new Client { Id = 1, UserId = 1, FullName = "Ahmed Mohamed", Email = "ahmed@example.com", PhoneNumber = "1121456789", ClientType = ClientType.individual, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 2, UserId = 1, FullName = "Sara Ali", Email = "sara@example.com", PhoneNumber = "2927654321", ClientType = ClientType.individual, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 3, UserId = 1, FullName = "Mohamed Hassan", Email = "mohamed@example.com", PhoneNumber = "31128833445", ClientType = ClientType.individual, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 4, UserId = 1, FullName = "Leila Ibrahim", Email = "leila@example.com", PhoneNumber = "4243344556", ClientType = ClientType.individual, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 5, UserId = 1, FullName = "Ali Youssef", Email = "ali@example.com", PhoneNumber = "0344455667", ClientType = ClientType.individual, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 6, UserId = 1, FullName = "Fatima Saeed", Email = "fatima@example.com", PhoneNumber = "5445566778", ClientType = ClientType.individual, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 7, UserId = 1, FullName = "Khaled Abdullah", Email = "khaled@example.com", PhoneNumber = "6556677889", ClientType = ClientType.Company, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 8, UserId = 1, FullName = "Mariam Ahmed", Email = "mariam@example.com", PhoneNumber = "7667788990", ClientType = ClientType.Company, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 9, UserId = 1, FullName = "Youssef Ali", Email = "youssef@example.com", PhoneNumber = "0878899001", ClientType = ClientType.Company, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 10, UserId = 1, FullName = "Nora Mohamed", Email = "nora@example.com", PhoneNumber = "9889900112", ClientType = ClientType.Company, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 11, UserId = 1, FullName = "Hassan Ali", Email = "hassan@example.com", PhoneNumber = "14490011223", ClientType = ClientType.individual, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 12, UserId = 1, FullName = "Mona Saeed", Email = "mona@example.com", PhoneNumber = "01022122334", ClientType = ClientType.individual, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 13, UserId = 1, FullName = "Omar Khaled", Email = "omar@example.com", PhoneNumber = "01112233445", ClientType = ClientType.individual, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 14, UserId = 1, FullName = "Huda Ibrahim", Email = "huda@example.com", PhoneNumber = "2223344556", ClientType = ClientType.individual, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 15, UserId = 1, FullName = "Yasser Youssef", Email = "yasser@example.com", PhoneNumber = "03744455667", ClientType = ClientType.individual, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 16, UserId = 1, FullName = "Nadia Saeed", Email = "nadia@example.com", PhoneNumber = "0045566778", ClientType = ClientType.individual, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 17, UserId = 1, FullName = "Majed Abdullah", Email = "majed@example.com", PhoneNumber = "9956677889", ClientType = ClientType.Company, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 18, UserId = 1, FullName = "Salma Ahmed", Email = "salma@example.com", PhoneNumber = "0667788990", ClientType = ClientType.Company, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 19, UserId = 1, FullName = "Ziad Ali", Email = "ziad@example.com", PhoneNumber = "0228899001", ClientType = ClientType.Company, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false },
        new Client { Id = 20, UserId = 1, FullName = "Noor Mohamed", Email = "noor@example.com", PhoneNumber = "0874900112", ClientType = ClientType.Company, CreatedDate = new DateTime(2023, 10, 1), IsDeleted = false }
    };
    }

    public static List<AppUser> SeedSiteEnginners()
    {
        return new List<AppUser>
    {
        new AppUser
        {
            ...
            ConcurrencyStamp = "SOKZD3Q27H66B63UEVAFQDGKZBDGOBUX",
        ...
        return new List<Project>
    {
        new Project
        {
            ...
            Description = "Construction of a primary school in the city",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2022, 12, 1),
            Status = ProjectStatus.Active,
            SiteEngineerId = 21,
            ClientId = 1,
            SiteAddress = "City, Street 1",
        ...
        {
            Id = 2,
            Name = "Hospital Construction Project",
            Description = "Construction of a general hospital in the city",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2022, 12, 1),
            Status = ProjectStatus.Active,
            SiteEngineerId = 22,
            ClientId = 2,
            SiteAddress = "City, Street 2",
            GeographicalCoordinates = "24.7136, 46.6753",
            CreatedDate = new DateTime(2023, 10, 1),
            IsDeleted = false,
            CompletionDate = null,
        ...
        {
            Id = 3,
            Name = "Residential Complex Construction Project",
            Description = "Construction of a luxury residential complex",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2020, 8, 1),
            Status = ProjectStatus.Active,
            SiteEngineerId = 23,
            ClientId = 3,
            SiteAddress = "City, Street 3",
            GeographicalCoordinates = "24.7136, 46.6753",
            CreatedDate = new DateTime(2023, 10, 1),
            IsDeleted = false,
            CompletionDate = null,
        ...
        new Project
        {
            ...
            Description = "Construction of a bridge connecting two areas",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2020, 8, 1),
            Status = ProjectStatus.Active,
            SiteEngineerId = 24,
            ClientId = 4,
            SiteAddress = "City, Street 4",
            GeographicalCoordinates = "24.7136, 46.6753",
            CreatedDate = new DateTime(2023, 10, 1),
            IsDeleted = false,
            CompletionDate = null,
        ...
        {
            Id = 5,
            Name = "Factory Construction Project",
            Description = "Construction of a food production factory",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2020, 8, 1),
            Status = ProjectStatus.Active,
            SiteEngineerId = 25,
            ClientId = 5,
            SiteAddress = "City, Street 5",
            GeographicalCoordinates = "24.7136, 46.6753",
            CreatedDate = new DateTime(2023, 10, 1),
            IsDeleted = false,
            CompletionDate = null,
        ...
        {
            Id = 7,
            Name = "Train Station Construction Project",
            Description = "Construction of a modern train station",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2020, 8, 1),
            Status = ProjectStatus.Active,
            SiteEngineerId = 27,
            ClientId = 7,
            SiteAddress = "City, Street 7",
            GeographicalCoordinates = "24.7136, 46.6753",
            CreatedDate = new DateTime(2023, 10, 1),
            IsDeleted = false,
            CompletionDate = null,
        ...
        {
            Id = 8,
            Name = "Shopping Mall Construction Project",
            Description = "Construction of a large shopping mall",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2020, 8, 1),
            Status = ProjectStatus.Active,
            SiteEngineerId = 28,
            ClientId = 8,
            SiteAddress = "City, Street 8",
            GeographicalCoordinates = "24.7136, 46.6753",
            CreatedDate = new DateTime(2023, 10, 1),
            IsDeleted = false,
            CompletionDate = null,
        ...
        {
            Id = 9,
            Name = "University Construction Project",
            Description = "Construction of a modern university",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2020, 8, 1),
            Status = ProjectStatus.Active,
            SiteEngineerId = 29,
            ClientId = 9,
            SiteAddress = "City, Street 9",
            GeographicalCoordinates = "24.7136, 46.6753",
            CreatedDate = new DateTime(2023, 10, 1),
            IsDeleted = false,
            CompletionDate = null,
        ...
        {
            Id = 10,
            Name = "Public Park Construction Project",
            Description = "Construction of a large public park",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2020, 8, 1),
            Status = ProjectStatus.Active,
            SiteEngineerId = 30,
            ClientId = 10,
            SiteAddress = "City, Street 10",
            GeographicalCoordinates = "24.7136, 46.6753",
            CreatedDate = new DateTime(2023, 10, 1),
            IsDeleted = false,
            CompletionDate = null,
        ...
        {
            Id = 11,
            Name = "Public Library Construction Project",
            Description = "Construction of a public library in the city",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2022, 12, 1),
            Status = ProjectStatus.Active,
            SiteEngineerId = 31,
            ClientId = 11,
            SiteAddress = "City, Street 11",
            GeographicalCoordinates = "24.7136, 46.6753",
            CreatedDate = new DateTime(2023, 10, 1),
            IsDeleted = false,
            CompletionDate = null,
        ...
        {
            Id = 12,
            Name = "Sports Stadium Construction Project",
            Description = "Construction of a modern sports stadium",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2022, 12, 1),
            Status = ProjectStatus.Active,
            SiteEngineerId = 32,
            ClientId = 12,
            SiteAddress = "City, Street 12",
            GeographicalCoordinates = "24.7136, 46.6753",
            CreatedDate = new DateTime(2023, 10, 1),
            IsDeleted = false,
            CompletionDate = null,
        ...
        {
            Id = 13,
            Name = "Gas Station Construction Project",
            Description = "Construction of a modern gas station",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2022, 11, 1),
            Status = ProjectStatus.Active,
            SiteEngineerId = 33,
            ClientId = 13,
            SiteAddress = "City, Street 13",
            GeographicalCoordinates = "24.7136, 46.6753",
            CreatedDate = new DateTime(2023, 10, 1),
            IsDeleted = false,
            CompletionDate = null,
        ...
        {
            Id = 14,
            Name = "Health Center Construction Project",
            Description = "Construction of a health center in the city",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2020, 8, 1),
        ...
        {
            Id = 15,
            Name = "Commercial Complex Construction Project",
            Description = "Construction of a large commercial complex",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2020, 8, 1),
            Status = ProjectStatus.Completed,
            CompletionDate = new DateOnly(2020, 9, 1),
        ...
        {
            Id = 16,
            Name = "Power Plant Construction Project",
            Description = "Construction of a modern power plant",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2020, 8, 1),
            Status = ProjectStatus.Completed,
            CompletionDate = new DateOnly(2020, 9, 1),
        ...
        {
            Id = 17,
            Name = "Water Plant Construction Project",
            Description = "Construction of a modern water plant",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2020, 8, 1),
            Status = ProjectStatus.Pending,
            SiteEngineerId = 37,
            ClientId = 17,
            SiteAddress = "City, Street 17",
            GeographicalCoordinates = "24.7136, 46.6753",
            CreatedDate = new DateTime(2023, 10, 1),
            IsDeleted = false,
            CompletionDate = null,
        ...
        {
            Id = 18,
            Name = "Police Station Construction Project",
            Description = "Construction of a modern police station",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2020, 8, 1),
            Status = ProjectStatus.Pending,
            SiteEngineerId = 38,
            ClientId = 18,
            SiteAddress = "City, Street 18",
            GeographicalCoordinates = "24.7136, 46.6753",
            CreatedDate = new DateTime(2023, 10, 1),
            IsDeleted = false,
            CompletionDate = null,
        ...
        {
            Id = 19,
            Name = "Fire Station Construction Project",
            Description = "Construction of a modern fire station",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2020, 8, 1),
            Status = ProjectStatus.Cancelled,
            CancelationDate = new DateOnly(2020, 9, 1),
            CancelationReason = "Project was cancelled due to lack of funding",
            SiteEngineerId = 39,
            ClientId = 19,
            SiteAddress = "City, Street 19",
            GeographicalCoordinates = "24.7136, 46.6753",
            CreatedDate = new DateTime(2023, 10, 1),
            IsDeleted = false,
            CompletionDate = null
        ...
        {
            Id = 20,
            Name = "Cultural Center Construction Project",
            Description = "Construction of a modern cultural center",
            StartDate = new DateOnly(2022, 10, 1),
            ExpectedEndDate = new DateOnly(2020, 8, 1),
            Status = ProjectStatus.Cancelled,
            CancelationDate = new DateOnly(2020, 9, 1),
            CancelationReason = "Project was cancelled due to changing priorities",
            SiteEngineerId = 40,
            ClientId = 20,
            SiteAddress = "City, Street 20",
            GeographicalCoordinates = "24.7136, 46.6753",
            CreatedDate = new DateTime(2023, 10, 1),
            IsDeleted = false,
            CompletionDate = null
    ...
    public static List<Stage> SeedStages()
    {
        ...
        return new List<Stage>
        {
            ...
            new Stage { Id = 1, Name = "Design", Description = "مرحلة تصميم المدرسة", StartDate = new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 1 },
            new Stage { Id = 2, Name = "Construction", Description = "مرحلة بناء المدرسة", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate = new DateOnly(2022, 11, 1), ProjectId = 1 },
            new Stage { Id = 3, Name = "Finishing", Description = "مرحلة التشطيب النهائية", StartDate = new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate = new DateOnly(2022, 11, 1), ProjectId = 1 },

            // Stages for Project 2
            new Stage { Id = 4, Name = "Design", Description = "مرحلة تصميم المستشفى", StartDate = new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate = new DateOnly(2022, 11, 1), ProjectId = 2 },
            new Stage { Id = 5, Name = "Construction", Description = "مرحلة بناء المستشفى", StartDate = new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 2 },
            new Stage { Id = 6, Name = "Finishing", Description = "مرحلة التشطيب النهائية", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate = new DateOnly(2022, 11, 1), ProjectId = 2 },

            // Stages for Project 3
            new Stage { Id = 7, Name = "Design", Description = "مرحلة تصميم المجمع السكني", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 3 },
            new Stage { Id = 8, Name = "Construction", Description = "مرحلة بناء المجمع السكني", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1) ,ProjectId = 3 },
            new Stage { Id = 9, Name = "Finishing", Description = "مرحلة التشطيب النهائية", StartDate =  new DateOnly(2022, 11, 1),  CreatedDate = new DateTime(2023, 10, 1),ExpectedEndDate =  new DateOnly(2022, 11, 1) ,ProjectId = 3 },

            // Stages for Project 4
            new Stage { Id = 10, Name = "Design", Description = "مرحلة تصميم الجسر", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 4 },
            new Stage { Id = 11, Name = "Construction", Description = "مرحلة بناء الجسر", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1) ,ProjectId = 4 },
            new Stage { Id = 12, Name = "Finishing", Description = "مرحلة التشطيب النهائية", StartDate =  new DateOnly(2022, 11, 1),  CreatedDate = new DateTime(2023, 10, 1),ExpectedEndDate =  new DateOnly(2022, 11, 1) ,ProjectId = 4 },

            // Stages for Project 5
            new Stage { Id = 13, Name = "Design", Description = "مرحلة تصميم المصنع", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 5 },
            new Stage { Id = 14, Name = "Construction", Description = "مرحلة بناء المصنع", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1) ,ProjectId = 5 },
            new Stage { Id = 15, Name = "Finishing", Description = "مرحلة التشطيب النهائية", StartDate =  new DateOnly(2022, 11, 1) ,  CreatedDate = new DateTime(2023, 10, 1),ExpectedEndDate =  new DateOnly(2022, 11, 1) ,ProjectId = 5 },

            // Stages for Project 6
            new Stage { Id = 16, Name = "Design", Description = "مرحلة تصميم الفندق", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 6 },
            new Stage { Id = 17, Name = "Construction", Description = "مرحلة بناء الفندق", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 6 },
            new Stage { Id = 18, Name = "Finishing", Description = "مرحلة التشطيب النهائية", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1) ,ProjectId = 6 },

            // Stages for Project 7
            new Stage { Id = 19, Name = "Design", Description = "مرحلة تصميم محطة القطار", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 7 },
            new Stage { Id = 20, Name = "Construction", Description = "مرحلة بناء محطة القطار", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 7 },
            new Stage { Id = 21, Name = "Finishing", Description = "مرحلة التشطيب النهائية", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1) ,ProjectId = 7 },

            // Stages for Project 8
            new Stage { Id = 22, Name = "Design", Description = "مرحلة تصميم المركز التجاري", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 8 },
            new Stage { Id = 23, Name = "Construction", Description = "مرحلة بناء المركز التجاري", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 8 },
            new Stage { Id = 24, Name = "Finishing", Description = "مرحلة التشطيب النهائية", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1) ,ProjectId = 8 },

            // Stages for Project 9
            new Stage { Id = 25, Name = "Design", Description = "مرحلة تصميم الجامعة", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 9 },
            new Stage { Id = 26, Name = "Construction", Description = "مرحلة بناء الجامعة", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 9 },
            new Stage { Id = 27, Name = "Finishing", Description = "مرحلة التشطيب النهائية", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1) ,ProjectId = 9 },

            // Stages for Project 10
            new Stage { Id = 28, Name = "Design", Description = "مرحلة تصميم الحديقة العامة", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 10 },
            new Stage { Id = 29, Name = "Construction", Description = "مرحلة بناء الحديقة العامة", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1) ,ProjectId = 10 },
            new Stage { Id = 30, Name = "Finishing", Description = "مرحلة التشطيب النهائية", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1) ,ProjectId = 10 },


            // Stages for Project 11
            new Stage { Id = 31, Name = "Planning", Description = "مرحلة التخطيط للمكتبة العامة", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 11 },
            new Stage { Id = 32, Name = "Execution", Description = "مرحلة بناء المكتبة العامة", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate = new DateOnly(2022, 11, 1), ProjectId = 11 },
            new Stage { Id = 33, Name = "Final Testing", Description = "الفحص النهائي للمكتبة قبل الافتتاح", StartDate = new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate = new DateOnly(2022, 11, 1), ProjectId = 11 },

            // Stages for Project 12
            new Stage { Id = 34, Name = "Planning", Description = "مرحلة التخطيط للملعب الرياضي", StartDate = new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate = new DateOnly(2022, 11, 1), ProjectId = 12 },
            new Stage { Id = 35, Name = "Execution", Description = "مرحلة بناء الملعب الرياضي", StartDate = new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate = new DateOnly(2022, 11, 1), ProjectId = 12 },
            new Stage { Id = 36, Name = "Final Testing", Description = "الفحص النهائي للملعب الرياضي", StartDate = new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate = new DateOnly(2022, 11, 1), ProjectId = 12 },

            // Stages for Project 13
            new Stage { Id = 37, Name = "Planning", Description = "مرحلة التخطيط لمحطة الوقود", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 13 },
            new Stage { Id = 38, Name = "Execution", Description = "مرحلة بناء محطة الوقود", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 13 },
            new Stage { Id = 39, Name = "Final Testing", Description = "الفحص النهائي لمحطة الوقود", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 13 },

            // Stages for Project 14
            new Stage { Id = 40, Name = "Planning", Description = "مرحلة التخطيط للمركز الصحي", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 14 },
            new Stage { Id = 41, Name = "Execution", Description = "مرحلة بناء المركز الصحي", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 14 },
            new Stage { Id = 42, Name = "Final Testing", Description = "الفحص النهائي للمركز الصحي", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 14 },

            // Stages for Project 15
            new Stage { Id = 43, Name = "Planning", Description = "مرحلة التخطيط للمجمع التجاري", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 15 },
            new Stage { Id = 44, Name = "Execution", Description = "مرحلة بناء المجمع التجاري", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 15 },
            new Stage { Id = 45, Name = "Final Testing", Description = "الفحص النهائي للمجمع التجاري", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1) ,ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 15 },

            // Stages for Project 16
            new Stage { Id = 46, Name = "Planning", Description = "مرحلة التخطيط لمحطة الكهرباء", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 16 },
            new Stage { Id = 47, Name = "Execution", Description = "مرحلة بناء محطة الكهرباء", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 16 },
            new Stage { Id = 48, Name = "Final Testing", Description = "الفحص النهائي لمحطة الكهرباء", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 16 },

            // Stages for Project 17
            new Stage { Id = 49, Name = "Planning", Description = "مرحلة التخطيط لمحطة المياه", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 17 },
            new Stage { Id = 50, Name = "Execution", Description = "مرحلة بناء محطة المياه", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 17 },
            new Stage { Id = 51, Name = "Final Testing", Description = "الفحص النهائي لمحطة المياه", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 17 },

            // Stages for Project 18
            new Stage { Id = 52, Name = "Planning", Description = "مرحلة التخطيط لمركز الشرطة", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 18 },
            new Stage { Id = 53, Name = "Execution", Description = "مرحلة بناء مركز الشرطة", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 18 },
            new Stage { Id = 54, Name = "Final Testing", Description = "الفحص النهائي لمركز الشرطة", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 18 },

            // Stages for Project 19
            new Stage { Id = 55, Name = "Planning", Description = "مرحلة التخطيط لمحطة الإطفاء", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 19 },
            new Stage { Id = 56, Name = "Execution", Description = "مرحلة بناء محطة الإطفاء", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 19 },
            new Stage { Id = 57, Name = "Final Testing", Description = "الفحص النهائي لمحطة الإطفاء", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 19 },

            // Stages for Project 20
            new Stage { Id = 58, Name = "Planning", Description = "مرحلة التخطيط للمركز الثقافي", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 20 },
            new Stage { Id = 59, Name = "Execution", Description = "مرحلة بناء المركز الثقافي", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1),  ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 20 },
            new Stage { Id = 60, Name = "Final Testing", Description = "الفحص النهائي للمركز الثقافي", StartDate =  new DateOnly(2022, 11, 1), CreatedDate = new DateTime(2023, 10, 1) ,ExpectedEndDate =  new DateOnly(2022, 11, 1), ProjectId = 20 }
        };
    }
    ...
    public static List<IdentityUserRole<int>> SeedUserRoles()
    {
        return new List<IdentityUserRole<int>>
        {
            ...
            new IdentityUserRole<int> { RoleId = 2, UserId = 21 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 22 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 23 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 24 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 25 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 26 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 27 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 28 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 29 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 30 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 31 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 32 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 33 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 34 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 35 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 36 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 37 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 38 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 39 },
            new IdentityUserRole<int> { RoleId = 2, UserId = 40 }
        };
    }

...
namespace ConstructionManagementAssistant.EF.Migrations
{
    ...
    [Migration("20250510110604_add document entity with its relationship")]
    partial class adddocumententitywithitsrelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionManagementAssistant.Core.Entites.DocumentClassification", b =>
                {
                    ...
                    b.HasIndex(new[] { "DocumentType" }, "UniqueType")
                        .IsUnique()

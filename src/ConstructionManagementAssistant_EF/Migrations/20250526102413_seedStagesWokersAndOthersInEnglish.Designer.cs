...
namespace ConstructionManagementAssistant.EF.Migrations
{
    ...
    [Migration("20250526102413_seedStagesWokersAndOthersInEnglish")]
    partial class seedStagesWokersAndOthersInEnglish
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConstructionManagementAssistant.Core.Entites.Project", b =>
                {
                    ...
                    b.HasOne("ConstructionManagementAssistant.Core.Identity.AppUser", "SiteEngineer")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("ConstructionManagementAssistant.Core.Identity.AppUser", b =>
                {
                    b.HasOne("ConstructionManagementAssistant.Core.Identity.AppUser", "BelongToUser")
                        .WithMany("AppUsers")
                        .HasForeignKey("BelongToUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("BelongToUser");
                });
